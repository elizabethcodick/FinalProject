...
class InstructionsList : ListFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        itemsArrayList = (activity as MainActivity).setInstructionsList()

        listAdapter = ItemsArrayAdapter (this.context!!,
            R.layout.fragment_instructions_list,
            itemsArrayList)
    ...
    inner class ItemsArrayAdapter(context: Context, resource: Int,
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            if(convertView == null){
                ...
                //set it up
                holder = ViewHolder()
                holder.detailTextView = retView.findViewById<TextView>(R.id.instruction_list)
                retView.tag = holder
